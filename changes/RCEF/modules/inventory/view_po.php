...
$statuses = $pdo->query("SELECT * FROM purchase_order_status")->fetchAll();
...
<div class="container-fluid">
        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                    ...
                    <?php if (hasPermission('purchase_change_status')): ?>
                <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#statusChangeModal">
    ...
    $purchaseOrder['status_id'] == 3): ?>
                        <a href="receive_purchase.php?id=<?= $poId ?>" class="btn btn-outline-primary">
                            <i class="fas fa-edit"></i> Receieve
                        </a>
                    <?php endif; ?>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="h5"> RWF <?= number_format($purchaseOrder['total_amount'] + $taxTotal, 2) ?></p>
                    </div>
                </div>
            </div>
