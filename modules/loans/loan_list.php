...
$sql = "SELECT l.*, CONCAT(u.first_name, ' ', u.last_name)as borrower_name,
        ...
        FROM loans l
        LEFT JOIN borrower u ON u.id = l.borrower_id
        WHERE 1=1";
        ...
        <tbody>
            <?php foreach ($loans as $loan): ?>
                <tr>
                    ...
                    <td>
                        <a href="loan_view.php?id=<?= $loan['id'] ?>" class="btn btn-sm btn-primary">View</a>
                        <?php if($loan['status']=='pending'){
                            ?>


    <?php if(hasPermission(36)){?>
    <a href="admin_approve.php?id=<?= $loan['id'] ?>" class="btn btn-sm btn-success">Approve</a>
<?php }else{
